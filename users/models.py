...
class Nxproduct(models.Model):
    product_id = models.CharField(max_length=30, unique=True)
    product_name = models.CharField(max_length=100, blank=True)
    license_price = models.FloatField(blank=True, default=0)
    Annual_maintain_Price = models.FloatField(blank=True, default=0)
    Yearly_Sub_Price = models.FloatField(blank=True, default=0)
    new_buy = models.FloatField(blank=True, default=0)
    data_import = models.DateField(default=date.today)
#
